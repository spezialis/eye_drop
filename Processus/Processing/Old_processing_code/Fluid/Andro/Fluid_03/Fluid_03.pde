...
void draw() {
  ...
  for (int i=0; i<N; i++) {
    ...
    //fill(colors[i]);
    fill(constrain(map(particle.z, 2 * RADIUS / 3, RADIUS * 2, 255, 0), 0, 255), constrain(map(particle.z, 2 * RADIUS / 3, RADIUS * 2, 255, 240), 240, 255), constrain(map(particle.z, 2 * RADIUS / 3, RADIUS * 2, 255, 220), 220, 255));
